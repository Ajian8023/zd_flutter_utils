import 'package:zd_flutter_utils/extens/transform_utils.dart';
import 'package:zd_flutter_utils/object/object_utils.dart';
import 'package:zd_flutter_utils/regex/regex_constants.dart';
import 'package:zd_flutter_utils/regex/regex_utils.dart';
...
class ValidatorUtils {
  ...
  /// 检查字符串是否为音频文件
  static bool isAudio(String s) => RegexUtils.hasMatch(s, RegexConstants.audio);
  ...
  /// 检查字符串是否为txt文本文件
  static bool isTxt(String s) => RegexUtils.hasMatch(s, RegexConstants.txt);
  ...
  /// 检查字符串是否为ppt文件
  static bool isPPT(String s) => RegexUtils.hasMatch(s, RegexConstants.ppt);
  ...
  /// 检查字符串是否为url文件
  static bool isURL(String s) => RegexUtils.hasMatch(s, RegexConstants.url);
  ...
  /// 检查字符串值是否驼峰大小写。
  static bool isCamelCase(String s) => s == TransformUtils.camelCase(s);
