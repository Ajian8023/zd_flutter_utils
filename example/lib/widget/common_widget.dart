...
class CommonWidget {
  ...
  late VoidCallback _onTapFunc;
  late VoidCallback _onDoubleTapFunc;
  late VoidCallback _onLongPressFunc;
  ...
  CommonWidget expanded({Key? key, int flex = 1}) {
    _widget = new Expanded(key: key, flex: flex, child: _widget ?? Container());
    return this;
  }
  ...
  ///添加点击事件
  CommonWidget onTap(VoidCallback func, {Key? key}) {
    _onTapFunc = func;
    _widget = new GestureDetector(
      key: key,
      child: _widget,
  ...
  ///双击
  CommonWidget onDoubleTap(VoidCallback func, {Key? key}) {
  ...
  ///长按
  CommonWidget onLongPress(VoidCallback func, {Key? key}) {
