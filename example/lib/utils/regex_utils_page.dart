  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: new Column(
        children: <Widget>[
          new Text(
              "简单验证手机号：" + RegexUtils.isMobileSimple("13667225184").toString()),
          new Text(
              "精确验证手机号：" + RegexUtils.isMobileExact("13667225184").toString()),
          new Text("验证电话号码：" + RegexUtils.isTel(str2).toString()),
          new Text("验证身份证号码 15 位：" + RegexUtils.isIDCard15(card15).toString()),
          new Text(
              "简单验证身份证号码 18 位：" + RegexUtils.isIDCard18(card18).toString()),
          new Text("精确验证身份证号码 18 位：" +
              RegexUtils.isIDCard18Exact(card18).toString()),
          new Text(
              "验证邮箱：" + RegexUtils.isEmail("yangchong211@163.com").toString()),
          new Text("验证 URL：" +
              RegexUtils.isURL("https://github.com/yangchong211").toString()),
