...
import 'package:zd_flutter_utils/bus/event_bus_helper.dart';
import 'package:zd_flutter_utils/bus/event_bus_service.dart';
...
class _DatePageState extends State<BusPage> {
  ...
  void registerBus() {
    _subscription =
        EventBusService.instance.eventBus.on<EventMessage>().listen((event) {
