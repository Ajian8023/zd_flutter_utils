...
import 'package:zd_flutter_utils/file/file_utils.dart';
import 'package:zd_flutter_utils/timer/timer_utils.dart';
...
class StorageState extends State<TimerPage> {
  ...
  ZdTimerUtils timerUtils = ZdTimerUtils();
  void start() {
    stop();
    timerUtils = new ZdTimerUtils(mInterval: 1000, mTotalTime: 60);
