...
import 'package:zd_flutter_utils/image/image_utils.dart';
...
class _PageState extends State<ImagePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBar(
        title: new Text("ImageUtils 图片工具类"),
        centerTitle: true,
      ),
      body: ListView(
        children: [
          Column(
            children: <Widget>[
              ImageUtils.showNetImageWh(
                  "https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/586766ce5091479d9a10215141c51d13~tplv-k3u1fbpfcp-zoom-in-crop-mark:652:0:0:0.awebp",
                  100,
                  100),
              ImageUtils.showNetImageWh(
              ...
              ImageUtils.showNetImageWhClip(
                  ...
                  200,
                  30),
              ImageUtils.showNetImageCircle(
                  "https://img-blog.csdnimg.cn/20201013094115174.png", 100),
            ],
          ),
        ],
      ),
